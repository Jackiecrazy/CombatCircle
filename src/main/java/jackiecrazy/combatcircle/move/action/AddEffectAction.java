...
public class AddEffectAction extends Action {
    ...
    public int perform(@Nullable TimerAction parent, Entity performer, Entity target) {
        ...
        if (me != null && recipient.resolve(performer, target) instanceof LivingEntity e) {
            e.addEffect(new MobEffectInstance(me, (int) (duration.resolve(performer, target)*20), (int) potency.resolve(performer, target)));
        }
        return 0;
    }
}
